...
// Parsed from <sl/c_api/types_c.h>
...
// Parsed from <sl/c_api/zed_interface.h>
...
// #endif
    ...
    */
    ...
    @param camera_id : Id of the camera instance.
    */
    public static native @ByVal org.bytedeco.cuda.cudart.CUctx_st sl_get_cuda_context(int camera_id);
    ...
    */
    ...
    @return An \ref SL_ERROR_CODE if something went wrong.
     */
    public static native int sl_get_region_of_interest(int camera_id, Pointer roi_mask, int width, int height);
    /**
    ...
    */
    public static native int sl_convert_image(Pointer image_in_ptr, Pointer image_signed_ptr, @ByVal org.bytedeco.cuda.cudart.CUstream_st stream);
